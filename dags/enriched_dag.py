...
with dag as dag:
    ...
    create_table_prescriptions = PostgresOperator(
        task_id='create_table_prescriptions',
        sql='sql/enriched/tables/create_table_prescriptions.sql'
    )
    ...
    check_table_prescriptions = PostgresValueCheckOperator(
        task_id = 'check_table_prescriptions',
        sql = 'sql/enriched/tests/test_table_prescriptions.sql',
        pass_value=True
    )
    ...
    create_schema >> [create_table_drug, create_table_provider, create_table_prescriptions] >> finish_transform >> [check_table_provider, check_table_drug, check_table_prescriptions] >> finish_tests